...
% end
if ~aliscomputer && experimentcomputer && ~(newexpcomputer)
    condFiles = 'C:\Users\eeglab1\Desktop\Ali Yılmaztekin\imperil6materials\design_beta\imperil6BetaConditionFiles';
    condFilesTraining = 'C:\Users\eeglab1\Desktop\Ali Yılmaztekin\imperil6materials\design_beta\imperil6BetaConditionFilesTraining';
    stimuliDIR = 'C:\Users\eeglab1\Desktop\Ali Yılmaztekin\imperil6materials\design_beta\testObjectsTransparentExtended';
    trainingStimuliDIR = 'C:\Users\eeglab1\Desktop\Ali Yılmaztekin\imperil6materials\design_beta\trainingStimuliExp6';
    outputDest = 'C:\Users\eeglab1\Desktop\Ali Yılmaztekin\imperil6materials\design_beta\outputFiles';
    mouseDest = 'C:\Users\eeglab1\Desktop\Ali Yılmaztekin\imperil6materials\design_beta\trackingFiles';
    workspaceDest = 'C:\Users\eeglab1\Desktop\Ali Yılmaztekin\imperil6materials\design_beta\experimentWorkspace';
    subjectCountDest = 'C:\Users\eeglab1\Desktop\Ali Yılmaztekin\imperil6materials\design_beta';
...
if exist('imperil6Betasubjectcount.mat', 'file')
    load('imperil6Betasubjectcount.mat', 'lastParticipantNumber');
else
...
if participantNumber == 999
    ...
    save('imperil6Betasubjectcount.mat', 'lastParticipantNumber');
...
save(fullfile(subjectCountDest, 'imperil6Betasubjectcount.mat'), 'lastParticipantNumber');
...
currentCond = sprintf('imperil6Betacond%d.mat', currentConditionNumber);
currentTrainingCond = sprintf('imperil6BetaTrainCond%d.mat', currentConditionNumber);
...
imageSize = [154 154]; % %60 of the usual 256x256 size  

% Memory array 1 presentation circle settings
% The memoranda will be drawn along this shape
memArray1.radius = 180; %60% of the original 300
...
for trial = 1:numTrials
    ...
    if trial >= 2 && (outputMatrix(trial,3) ~= outputMatrix((trial-1),3))
        ...
        % Save the data
        currentLabel = sprintf('imperil6BetaDataID%d.mat', lastParticipantNumber);
        fullPath = fullfile(outputDest, currentLabel);
        save(fullPath, 'outputMatrix');

        % Save the mouse data
        currentLabel2 = sprintf('imperil6BetaDataMouseID%d.mat', lastParticipantNumber);
        ...
        % Save the workspace
        currentLabel3 = sprintf('imperil6BetaWorkspaceID%d.mat', lastParticipantNumber);
