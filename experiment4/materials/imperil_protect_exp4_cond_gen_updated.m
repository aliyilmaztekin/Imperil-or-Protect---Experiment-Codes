%% Imperil or Protect 4 - Condition Matrix Generator (v3)
% Coded by A.Y.
...
%% 10.03.2026: Minor edit to ensure equal trial counts per condition. 
% In the v2, the balance was ever so slightly off across conditions by 1 or
% 2 trials. 
...
for condFile = 1:15
    ...
    % The context change flow in the extra 30 trials and training is pre-determined.
    % The extra block is set so that the entire 540-trial matrix sums to 45 trials
    % per condition, while the first 480 trials still sum to 40 trials per condition.
    
    extraContext = [0 NaN NaN NaN 0 NaN ...
                    0 NaN NaN NaN 0 NaN ...
                    0 NaN NaN NaN 0 NaN ...
                    0 NaN NaN NaN 0 NaN ...
                    1 NaN NaN NaN 1 NaN]';
    
    trainingContext = [0 NaN NaN NaN 1 NaN ...
                       1 NaN NaN NaN 0 NaN ...
                       1 NaN NaN NaN 1 NaN ...
                       1 NaN NaN NaN 1 NaN ...
                       1 NaN NaN NaN 1 NaN]';
    
    finalMatrix((desiredTrialCount+1):(desiredTrialCount+30),2) = extraContext;
    ...
    fprintf('EXP rep1 ctx0: %d\n', sum(finalMatrix(1:desiredTrialCount,1) == 1 & finalMatrix(1:desiredTrialCount,2) == 0));
    fprintf('EXP rep1 ctx1: %d\n', sum(finalMatrix(1:desiredTrialCount,1) == 1 & finalMatrix(1:desiredTrialCount,2) == 1));
    fprintf('EXP rep5 ctx0: %d\n', sum(finalMatrix(1:desiredTrialCount,1) == 5 & finalMatrix(1:desiredTrialCount,2) == 0));
    fprintf('EXP rep5 ctx1: %d\n', sum(finalMatrix(1:desiredTrialCount,1) == 5 & finalMatrix(1:desiredTrialCount,2) == 1));
end
