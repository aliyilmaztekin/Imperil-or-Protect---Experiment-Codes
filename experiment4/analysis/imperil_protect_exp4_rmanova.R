...
p1 <- ggplot(subject_means_before, aes(x = mean_DV)) +
  geom_histogram(bins = 15, fill = "steelblue", alpha = .7) +
  geom_vline(xintercept = grand_mean, color = "red", linetype = "dashed") +
  labs(title = "Before Outlier Removal", x = "Subject Mean DV")

p2 <- ggplot(subject_means_after, aes(x = mean_DV)) +
  geom_histogram(bins = 15, fill = "darkgreen", alpha = .7) +
  geom_vline(xintercept = grand_mean, color = "red", linetype = "dashed") +
  labs(title = "After Outlier Removal", x = "Subject Mean DV")
