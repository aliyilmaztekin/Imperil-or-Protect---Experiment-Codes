...
exp1_ws_hybrid_plot <- ggplot() +
  ...
  theme(
    ...
    axis.text.x = element_text(size = 20, margin = margin(t = 8), color = "black"),
    axis.text.y = element_text(size = 20, margin = margin(r = 8), color = "black"),
    axis.ticks.length = unit(0.3, "cm"),
    text = element_text(family = "Arial")
  )

print(exp1_ws_hybrid_plot)


ggsave(
  filename = "exp1_ws_hybrid_plot.png",
